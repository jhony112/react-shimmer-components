 ...
 * @constructor
 */
const ShimmerContentBlock = ({ card, title, text, cta, thumbnailWidth, thumbnailHeight, reverse }) => {
    const renderContent = () => {
        return (
            <div
            ...
            >
                ...
                >
                    <ShimmerThumbnail width={thumbnailWidth} height={thumbnailHeight} className="h-100 m-0" />
                </div>
