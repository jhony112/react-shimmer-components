 ...
 * @constructor
 */
const ShimmerPostItem = ({ cta, title, text, imageType, imageWidth, imageHeight }) => {
    return (
        <ShimmerCard>
            {imageType === 'thumbnail' && (
                <ShimmerThumbnail height={imageHeight} width={imageWidth} className={imageWidth && imageWidth !== 'w-100' ? 'm-30 mb-0' : 'mb-0'} />
            )}
            {imageType === 'circular' && <ShimmerCircularImage size={imageWidth} className="m-30 mb-0" />}
            <div className="p-30">
