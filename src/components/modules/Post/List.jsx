...
const ShimmerPostList = ({ row, col, gap, className, postStyle }) => {
    const posts = {
        ...
        STYLE_SIX: <ShimmerPostItem title text cta imageType="thumbnail" imageWidth={80} imageHeight={80} contentCenter />,
        STYLE_SEVEN: <ShimmerPostItem text cta imageType="thumbnail" imageWidth={80} imageHeight={80} contentCenter />,
        STYLE_EIGHT: <ShimmerPostItem title cta imageType="thumbnail" imageWidth={80} imageHeight={80} contentCenter />,
    };
